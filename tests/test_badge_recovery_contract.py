...
class BadgeRecoveryContractTests(unittest.TestCase):
    def test_workflow_has_write_only_where_needed_and_serializes_updates(self):
        ...
        self.assertIn("update-release-badge@f042163c0d83712736bbc9cc168c4f9f98c488cf", text)
        self.assertIn("release-badge-resolver@f042163c0d83712736bbc9cc168c4f9f98c488cf", text)
